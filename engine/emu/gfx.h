...
#define SWAP_DWORD(dword) dword = ((((dword)&0x000000ff) << 24) | (((dword)&0x0000ff00) << 8) | (((dword)&0x00ff0000) >> 8) | (((dword)&0xff000000) >> 24))
...
#define COLOR_SUB1_2(C1, C2) \
	GFX.ZERO[(((C1) | RGB_HI_BITS_MASKx2) - ((C2)&RGB_REMOVE_LOW_BITS_MASK)) >> 1]
