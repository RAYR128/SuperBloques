...
void CompilarBloquesBhv(std::string init, std::string main, std::string identificador, std::vector<NodoBloque> &lista) {
...
void Escena::Compilar() {
	CompilarBloquesBhv("ESCENA_INIT", "ESCENA_MAIN", Nombre, Bloques);
}

void ObjetoEscena::Compilar() {
	CompilarBloquesBhv("OBJETO_INIT", "OBJETO_MAIN", Nombre, Bloques);
}