...
export const VALUE_INPUTS = {
	...
	animacion_scene_set_layer2_position_y: ["VAL"],
	animacion_scene_set_layer3_position_x: ["VAL"],
...
const JSON_BLOCKS = [
	...
	{
		type: "animacion_scene_layer1_position_x",
		message0: "posicion capa 1 x en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_layer1_position_y",
		message0: "posicion capa 1 y en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_layer2_position_x",
		message0: "posicion capa 2 x en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_layer2_position_y",
		message0: "posicion capa 2 y en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_layer3_position_x",
		message0: "posicion capa 3 x en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_layer3_position_y",
		message0: "posicion capa 3 y en escena",
		output: "Number",
		style: "animacion_blocks",
	},
	{
		type: "animacion_scene_set_layer1_position_x",
	...
	{
		type: "animacion_scene_set_layer1_position_y",
	...
	{
		type: "animacion_scene_set_layer2_position_x",
	...
	{
		type: "animacion_scene_set_layer2_position_y",
	...
	{
		type: "animacion_scene_set_layer3_position_x",
	...
	{
		type: "animacion_scene_set_layer3_position_y",
...
const FLYOUT = {
	...
	animacion: [
		...
		{kind: "block", type: "animacion_scene_layer2_position_y"},
		{kind: "block", type: "animacion_scene_layer3_position_x"},
		{kind: "block", type: "animacion_scene_layer3_position_y"},
		bloqueConSombras("animacion_scene_set_layer1_position_x", {VAL: shadowNumero()}),
		bloqueConSombras("animacion_scene_set_layer1_position_y", {VAL: shadowNumero()}),
		bloqueConSombras("animacion_scene_set_layer2_position_x", {VAL: shadowNumero()}),
		bloqueConSombras("animacion_scene_set_layer2_position_y", {VAL: shadowNumero()}),
		bloqueConSombras("animacion_scene_set_layer3_position_x", {VAL: shadowNumero()}),
...
export const CATEGORIAS = ["mocion", "animacion", "sonido", "control", "evento", "variable", "operacion", "sensor"];
